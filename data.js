...
const chars = [
  new Char({name:"Lara", hits:45, next:'Goblin1', charType:'pc', current:true, init:5, turnStarted:true, will:2, attacks:[
  ...
  new Char({name:"Goblin1", hits:35, next:'Kyle', charType:'std', attacks:[
    new WeaponAttack("Broad sword", 2),
    new WeaponAttack("Unarmed", 2),
  ]}),
  new Char({name:"Kyle", hits:50, next:'Ogre', charType:'pc', ac:1, reflex:2, attacks:[
  ...
  new Char({name:"Jon", hits:100, next:'Goblin2', charType:'pc', ac:3, reflex:2, attacks:[
  ...
  new Char({name:"Goblin2", hits:35, next:'Ghost', init:"Goblin1", charType:'std', attacks:[
    new WeaponAttack("Broad sword", 2),
    new WeaponAttack("Unarmed", 2),
  ]}),
  new Char({name:"Ghost", hits:35, next:'Serpent_redux', init:4, charType:'std', ignoreAttackTypes:[false, 'silver'], onDeath:function() {
